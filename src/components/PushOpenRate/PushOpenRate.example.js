...
export const demos = [
  {
    name: 'Normal Push <10%',
    render: () => <PushOpenRate numOpened={24} numSent={2112} color="blue" />,
  },
  {
    name: 'Normal Push >10%',
    render: () => <PushOpenRate numOpened={325} numSent={2112} color="blue" />,
  },
  {
    name: 'Normal Push Integer Percent',
    render: () => <PushOpenRate numOpened={100} numSent={1000} color="blue" />,
  },
  {
